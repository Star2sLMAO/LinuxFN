...
async def var(request,accountid: str,command: str):
  dirr = f'files/profiles/{accountid}'
  rvn = request.args['rvn'][0]
  #create profile if not exists
  if os.path.exists(dirr) == False:
    os.makedirs(dirr)
    shutil.copyfile('config/Default.json', dirr+'/settings.json')
...
'''+cosmaticsid+'''
  ...
  common_core_json = json.loads('{"profileRevision":1,"profileId":"common_core","profileChangesBaseRevision":1,"profileChanges":[{"changeType":"fullProfileUpdate","profile":{"_id":"accountid","created":"2021-03-24T19:19:01.988Z","updated":"2021-03-24T19:19:15.043Z","rvn":4,"wipeNumber":1,"accountId":"accountid","profileId":"common_core","version":"v2","items":{"Currency:MtxPurchased":{"attributes":{"platform":"EpicMobile"},"quantity":'+account_settings["v-bucks"]+',"templateId":"Currency:MtxPurchased"}},"stats":{"attributes":{"mtx_affiliate":"gki","current_mtx_platform":"EpicMobile","mtx_purchase_history":{}}},"commandRevision":2}}],"serverTime":"2021-03-26T18:12:19.384Z","profileCommandRevision":1,"responseVersion":1}')
  creative_json = json.loads('{"profileRevision":1,"profileId":"creative","profileChangesBaseRevision":1,"profileChanges":[{"changeType":"fullProfileUpdate","profile":{"created":"now","updated":"now","rvn":1,"wipeNumber":1,"accountId":"accountid","profileId":"creative","version":"13.40","items":{},"stats":{"attributes":{"last_used_battlelab_file":"","max_island_plots":90,"publish_allowed":true,"support_code":"edik1045","last_used_plot":"","permissions":[],"creator_name":"","publish_banned":false,"inventory_limit_bonus":0}},"_id":"accountid"}}],"serverTime":"2021-03-26T18:12:19.384Z","profileCommandRevision":1,"responseVersion":1}')
 #profile commands
