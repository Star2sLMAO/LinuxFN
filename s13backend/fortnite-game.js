...
app.get('/content/api/pages/fortnite-game', async (req, res) => {
    ...
    //                hidden: false,
    //                videoMute: true,
    //                tabTitleOverride: 'ShadowNites S13 V1.40 is here soon',
    //                _type:  'CommonUI Simple Message MOTD',
    //                title: '',
    //                body: 'ShadowNites S13 is cool ',
    //                videoLoop: false,
    //                videoStreamingEnabled: false,
    //                videoAutoplay: false,
    //                videoFullscreen: false,
    //                sortingPriority: 0,
    //                id: 'ShadowNitesS13-News',
    //                spotlight: false
    //            }
    //        ],
    ...
    data.data.battleroyalenewsv2 = {
        news: {
            motds: [{
                ...
                videoMute: false,
                hidden: false,
                tabTitleOverride: 'ShadowNites S13',
                _type: "CommonUI Simple Message MOTD"
                title: "ShadowNites S 13"
                body: "ShadowNites is not officially connected with Epic Games in any way"
                videoLoop: false,
                videoStreamingEnabled: false,
                sortingPriority: 0,
                id: 'ShadowNiteNewsBR',
